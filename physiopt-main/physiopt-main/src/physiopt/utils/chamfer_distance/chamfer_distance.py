...
def find_nearest_point(source, target):
    ...
    source_tensor = source.float().cuda()[None, ...]
    target_tensor = target.float().cuda()[None, ...]
    dist1, dist2, idx1, idx2 = ChamferDistance()(source_tensor, target_tensor)

    return idx1.cpu().numpy()[0]
